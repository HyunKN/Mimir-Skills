...
- 근접 target agent군에 대한 support level을 정의하는 동안 shared CLI surface를 기본 low-friction 실행 경로로 유지하기
...
- 근접 target agent군에 대해 `shared CLI support`, `documented support`, `thin adapter support` 수준을 정의하기
