...
- `decision_skills/` 아래의 shared CLI-friendly surface, 즉 `python -m decision_skills list`, `python -m decision_skills prepare-handoff`, `python -m decision_skills write-pr-rationale`
