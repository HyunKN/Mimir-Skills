...
7. Treat the generated Markdown as a first draft to review and tighten before handing it to another human or agent.
...
- Run [`scripts/generate_handoff.py`](scripts/generate_handoff.py) when you need a directly usable `handoff.md` draft from the current repository state.
