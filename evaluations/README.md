...
`capture-ci-investigation-beta-review.md` serves as the overclaiming and uncertainty-separation review anchor for the `capture-ci-investigation` skill-first workflow.
`capture-ci-investigation-repeated-observation.md` serves as the repeated-observation quality review for keeping the workflow bounded, evidence-separated, and wrapper-only by design.
